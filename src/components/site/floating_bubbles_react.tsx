        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl">
          {contactData.map((contact, index) => {
            ...
            return (
              ...
              >
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full backdrop-blur-lg border border-gray-200/50 dark:border-white/20 flex flex-col items-center justify-center transition-all duration-300 hover:scale-110 hover:backdrop-blur-xl bg-white/20 dark:bg-black/20 hover:bg-white/30 dark:hover:bg-black/30">
                  <Icon
                    size={24}
