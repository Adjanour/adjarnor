...
description: How do we write code that is both reusable across types and safe at compile time?
date: 2025-12-27
---

import CodePlayground from "@/components/blog/CodePlayground.astro"
import AbstractionLayers from "@/components/blog/diagrams/AbstractionLayers.astro"
import ErasureVsReification from "@/components/blog/diagrams/ErasureVsReification.astro"
